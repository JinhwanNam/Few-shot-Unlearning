...
class PreActBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, normalization="BatchNorm"):
        ...
        if normalization == "BatchNorm":
            ...
            print(f"Track running stats is {track}!")

            self.bn1 = nn.BatchNorm2d(in_planes, track_running_stats=track)
    ...
    def forward(self, x):
        torch.set_printoptions(linewidth=300, threshold=99999999, sci_mode=False, precision=3)
